  ...
  return (
    <Card className='w-[600px] shadow-md'>
      ...
      <CardContent className='space-y-4'>
        ...
        >
          <p className=' text-xm font-medium'>ID</p>
        ...
        <div
          className='flex flex-row items-center justify-between rounded-lg
				border p-3 shadow-sm'
        >
          <p className=' text-xm font-medium'>Name</p>
          <p className='truncate text-xs max-w-[180px] font-mono p-1 bg-slate-100 rounded-md'>
            {user?.name}
          </p>
        </div>
        ...
        <div
          className='flex flex-row items-center justify-between rounded-lg
				border p-3 shadow-sm'
        >
          <p className=' text-xm font-medium'>Email</p>
          <p className='truncate text-xs max-w-[180px] font-mono p-1 bg-slate-100 rounded-md'>
            {user?.email}
          </p>
        </div>
        ...
        <div
          className='flex flex-row items-center justify-between rounded-lg
				border p-3 shadow-sm'
        >
          <p className=' text-xm font-medium'>Role</p>
          <p className='truncate text-xs max-w-[180px] font-mono p-1 bg-slate-100 rounded-md'>
            {user?.role}
          </p>
        </div>
        ...
        <div
          className='flex flex-row items-center justify-between rounded-lg
				border p-3 shadow-sm'
        >
          <p className=' text-xm font-medium'>Two Factor</p>
